...
async def _handle_connection(
    ...
    *,
    ...
    # Request 1: provoke a function call, mirroring the core WebSocket agent flow.
...
start Crewon with the local websocket profile
""")
    sys.stdout.flush()
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description=(
            "Mock a minimal Responses API WebSocket endpoint for the core agent test flow.\n"
