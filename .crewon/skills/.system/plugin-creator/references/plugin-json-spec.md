...
- This repo’s scaffold writes `.crewon-plugin/plugin.json`; treat that as the manifest location this skill generates.
...
- `plugins` (`array`): Ordered plugin entries. This order determines how Crewon renders plugins.
