...
export interface components {
  schemas: {
    ...
    AccountSnapshot: {
      identity: components["schemas"]["AccountIdentitySnapshot"];
      authentication: components["schemas"]["AccountAuthenticationSnapshot"];
      usage: components["schemas"]["UnavailableAccountMetric"];
      rateLimits: components["schemas"]["UnavailableAccountMetric"];
    };
...
export interface operations {
  getAccountSnapshot: {
    ...
    requestBody?: never;
    responses: {
      /** @description Authenticated Control identity with explicitly unavailable unowned telemetry */
      200: {
        headers: {
          [name: string]: unknown;
        };
        content: {
          "application/json": components["schemas"]["GetAccountSnapshotResponse"];
        };
      };
