...
export type OfficeMemberContract = components["schemas"]["OfficeMember"];
export type OfficeExecutionTargetContract =
  components["schemas"]["OfficeExecutionTarget"];
export type OfficeContract = components["schemas"]["Office"];
export type CreateOfficeRequest = components["schemas"]["CreateOfficeRequest"];
export type OfficeMutationResponse =
  components["schemas"]["OfficeMutationResponse"];
export type GetOfficeResponse = components["schemas"]["GetOfficeResponse"];
export type ListOfficesResponse = components["schemas"]["ListOfficesResponse"];
export type StartOfficeRunRequest =
  components["schemas"]["StartOfficeRunRequest"];
export type AuthorizeOfficeRunResponse =
  components["schemas"]["AuthorizeOfficeRunResponse"];
