...
mod tests {
    ...
    fn session_metric_tags_include_expected_tags_in_order() {
        let tags = SessionMetricTagValues {
            ...
            session_source: "app_server",
            originator: "crewon_web",
        ...
        assert_eq!(
            ...
            vec![
                ...
                (SESSION_SOURCE_TAG, "app_server"),
                (ORIGINATOR_TAG, "crewon_web"),
