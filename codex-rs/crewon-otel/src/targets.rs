pub(crate) const OTEL_TARGET_PREFIX: &str = "crewon_otel";
pub(crate) const OTEL_LOG_ONLY_TARGET: &str = "crewon_otel.log_only";
pub(crate) const OTEL_TRACE_SAFE_TARGET: &str = "crewon_otel.trace_safe";
