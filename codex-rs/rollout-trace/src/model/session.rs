...
/// One Crewon thread/session participating in the rollout.
///
...
/// Provenance for a traced Crewon thread.
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
...
/// One activation of the Crewon runtime for one thread.
///
/// A Crewon turn groups protocol/runtime work for one thread activation.
