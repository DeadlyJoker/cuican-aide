...
/// Runtime operation requested by the model, a JS code cell, or Crewon itself.
///
...
pub struct ToolCall {
    ...
    /// Original invocation at the Crewon tool boundary.
    ///
    ...
    /// they describe how Crewon executed the request, not what the caller sent.
