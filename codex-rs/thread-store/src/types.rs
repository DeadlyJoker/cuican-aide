...
use crewon_protocol::protocol::ThreadMemoryMode as MemoryMode;
...
pub struct CreateThreadParams {
    /// Thread id generated by Crewon before opening persistence.
...
pub struct StoredThread {
    ...
    pub cwd: PathBuf,
    /// Client/runtime version captured for the thread.
...
pub struct ThreadMetadataPatch {
    ...
    /// Working directory.
    pub cwd: Option<PathBuf>,
    /// Client/runtime version that created the thread.
