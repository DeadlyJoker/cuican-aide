...
//! `schemars`) so they can be embedded in Crewon's own protocol structures.
...
// === Adapter helpers ===
//
// These types and conversions intentionally live in `crewon-protocol` so other crates can convert
