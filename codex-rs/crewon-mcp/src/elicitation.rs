...
//!
//! RMCP clients call into this module when a server asks Crewon to elicit data
//! from the user. It decides whether the request can be automatically accepted,
//! must be declined by policy, or should be surfaced as a Crewon protocol event
...
use crewon_protocol::approvals::ElicitationRequest;
...
use crewon_rmcp_client::SendElicitation;
