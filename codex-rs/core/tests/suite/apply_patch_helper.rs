...
use core_test_support::test_crewon::ApplyPatchModelOutput;
...
pub async fn apply_patch_harness() -> Result<TestCrewonHarness> {
    apply_patch_harness_with(|builder| builder).await
}

async fn apply_patch_harness_with(
    configure: impl FnOnce(TestCrewonBuilder) -> TestCrewonBuilder,
) -> Result<TestCrewonHarness> {
    let builder = configure(test_crewon());
    // Box harness construction so apply_patch helper tests do not inline the
    // full test-thread startup path into each test future.
    Box::pin(TestCrewonHarness::with_remote_env_builder(builder)).await
}

async fn submit_without_wait(harness: &TestCrewonHarness, prompt: &str) -> Result<()> {
...
async fn apply_patch_helper_uses_crewon_self_exe_with_linux_sandbox_helper_alias() -> Result<()> {
    skip_if_no_network!(Ok(()));

    let harness = apply_patch_harness().await?;
    let crewon_linux_sandbox_exe = harness
        .test()
        .config
        .crewon_linux_sandbox_exe
        .as_ref()
        .expect("linux test config should include crewon-linux-sandbox helper");
    assert_eq!(
        crewon_linux_sandbox_exe
            .file_name()
...
#[tokio::test(flavor = "multi_thread", worker_threads = 2)]
async fn apply_patch_helper_multiple_operations_integration() -> Result<()> {
    skip_if_no_network!(Ok(()));
...
#[tokio::test(flavor = "multi_thread", worker_threads = 2)]
async fn apply_patch_helper_multiple_chunks() -> Result<()> {
    skip_if_no_network!(Ok(()));
...
#[tokio::test(flavor = "multi_thread", worker_threads = 2)]
async fn apply_patch_helper_moves_file_to_new_directory() -> Result<()> {
    skip_if_no_network!(Ok(()));
...
#[tokio::test(flavor = "multi_thread", worker_threads = 2)]
async fn apply_patch_helper_updates_file_appends_trailing_newline() -> Result<()> {
    skip_if_no_network!(Ok(()));
...
#[tokio::test(flavor = "multi_thread", worker_threads = 2)]
async fn apply_patch_helper_insert_only_hunk_modifies_file() -> Result<()> {
    skip_if_no_network!(Ok(()));
...
#[tokio::test(flavor = "multi_thread", worker_threads = 2)]
async fn apply_patch_helper_move_overwrites_existing_destination() -> Result<()> {
    skip_if_no_network!(Ok(()));
...
#[tokio::test(flavor = "multi_thread", worker_threads = 2)]
async fn apply_patch_helper_move_without_content_change_has_no_turn_diff() -> Result<()> {
    skip_if_no_network!(Ok(()));
...
#[tokio::test(flavor = "multi_thread", worker_threads = 2)]
async fn apply_patch_helper_add_overwrites_existing_file() -> Result<()> {
    skip_if_no_network!(Ok(()));
...
#[tokio::test(flavor = "multi_thread", worker_threads = 2)]
async fn apply_patch_helper_rejects_invalid_hunk_header() -> Result<()> {
    skip_if_no_network!(Ok(()));
...
#[tokio::test(flavor = "multi_thread", worker_threads = 2)]
async fn apply_patch_helper_reports_missing_context() -> Result<()> {
    skip_if_no_network!(Ok(()));
...
#[tokio::test(flavor = "multi_thread", worker_threads = 2)]
async fn apply_patch_helper_reports_missing_target_file() -> Result<()> {
    skip_if_no_network!(Ok(()));
...
#[tokio::test(flavor = "multi_thread", worker_threads = 2)]
async fn apply_patch_helper_delete_missing_file_reports_error() -> Result<()> {
    skip_if_no_network!(Ok(()));
...
#[tokio::test(flavor = "multi_thread", worker_threads = 2)]
async fn apply_patch_helper_rejects_empty_patch() -> Result<()> {
    skip_if_no_network!(Ok(()));
...
#[tokio::test(flavor = "multi_thread", worker_threads = 2)]
async fn apply_patch_helper_delete_directory_reports_verification_error() -> Result<()> {
    skip_if_no_network!(Ok(()));
...
#[tokio::test(flavor = "multi_thread", worker_threads = 2)]
async fn apply_patch_helper_rejects_path_traversal_outside_workspace() -> Result<()> {
    skip_if_no_network!(Ok(()));
...
#[tokio::test(flavor = "multi_thread", worker_threads = 2)]
async fn apply_patch_helper_does_not_write_through_symlink_escape_outside_workspace() -> Result<()>
{
    skip_if_no_network!(Ok(()));
    skip_if_remote!(
        Ok(()),
...
#[tokio::test(flavor = "multi_thread", worker_threads = 2)]
async fn apply_patch_helper_preserves_existing_hard_link_outside_workspace() -> Result<()> {
    skip_if_no_network!(Ok(()));
    skip_if_remote!(
        Ok(()),
...
#[tokio::test(flavor = "multi_thread", worker_threads = 2)]
async fn apply_patch_helper_rejects_move_path_traversal_outside_workspace() -> Result<()> {
    skip_if_no_network!(Ok(()));
...
#[tokio::test(flavor = "multi_thread", worker_threads = 2)]
async fn apply_patch_helper_verification_failure_has_no_side_effects() -> Result<()> {
    skip_if_no_network!(Ok(()));
...
#[tokio::test(flavor = "multi_thread", worker_threads = 2)]
async fn apply_patch_helper_can_use_shell_command_output_as_patch_input() -> Result<()> {
    skip_if_no_network!(Ok(()));
    skip_if_remote!(
        Ok(()),
...
async fn apply_patch_custom_tool_streaming_emits_updated_changes() -> Result<()> {
    ...
    assert_eq!(
        ...
        Some(&crewon_protocol::protocol::FileChange::Add {
            content: String::new(),
        })
    );
    assert_eq!(
...
#[tokio::test(flavor = "multi_thread", worker_threads = 2)]
async fn apply_patch_helper_end_of_file_anchor() -> Result<()> {
    skip_if_no_network!(Ok(()));
...
#[tokio::test(flavor = "multi_thread", worker_threads = 2)]
async fn apply_patch_helper_missing_second_chunk_context_rejected() -> Result<()> {
    skip_if_no_network!(Ok(()));
