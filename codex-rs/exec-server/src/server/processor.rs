    ...
    while let Some(event) = incoming_rx.recv().await {
        ...
        match event {
            ...
            JsonRpcConnectionEvent::Message(message) => match message {
                crewon_app_server_protocol::JSONRPCMessage::Request(request) => {
                ...
                crewon_app_server_protocol::JSONRPCMessage::Notification(notification) => {
                ...
                crewon_app_server_protocol::JSONRPCMessage::Response(response) => {
                    warn!(
                ...
                crewon_app_server_protocol::JSONRPCMessage::Error(error) => {
                    warn!(
