...
impl<T: HttpTransport> ModelsClient<T> {
    ...
    fn append_client_version_query(req: &mut crewon_client::Request, client_version: &str) {
...
mod tests {
    ...
    async fn appends_client_version_query() {
        ...
        let client = ModelsClient::new(
            transport.clone(),
            provider("https://example.com/api/crewon"),
            Arc::new(DummyAuth),
        );
        ...
        assert_eq!(
            url,
            "https://example.com/api/crewon/models?client_version=0.99.0"
        );
    }
