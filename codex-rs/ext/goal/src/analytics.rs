...
use crewon_analytics::CrewonGoalEvent;
use crewon_analytics::GoalEventKind;
...
impl GoalAnalytics {
    ...
    pub(crate) fn cleared(&self, goal: &crewon_state::ThreadGoal) {
    ...
    fn track(
        ...
        self.client.track_goal_event(CrewonGoalEvent {
