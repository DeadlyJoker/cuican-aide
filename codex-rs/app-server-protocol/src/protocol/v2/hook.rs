...
use crewon_protocol::protocol::HookEventName as CoreHookEventName;
use crewon_protocol::protocol::HookExecutionMode as CoreHookExecutionMode;
use crewon_protocol::protocol::HookHandlerType as CoreHookHandlerType;
use crewon_protocol::protocol::HookOutputEntry as CoreHookOutputEntry;
use crewon_protocol::protocol::HookOutputEntryKind as CoreHookOutputEntryKind;
use crewon_protocol::protocol::HookRunStatus as CoreHookRunStatus;
use crewon_protocol::protocol::HookRunSummary as CoreHookRunSummary;
use crewon_protocol::protocol::HookScope as CoreHookScope;
use crewon_protocol::protocol::HookSource as CoreHookSource;
use crewon_protocol::protocol::HookTrustStatus as CoreHookTrustStatus;
