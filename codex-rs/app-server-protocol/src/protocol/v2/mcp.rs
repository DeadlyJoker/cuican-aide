...
use crewon_protocol::items::McpToolCallError as CoreMcpToolCallError;
use crewon_protocol::mcp::CallToolResult as CoreMcpCallToolResult;
use crewon_protocol::mcp::McpServerInfo;
use crewon_protocol::mcp::Resource as McpResource;
pub use crewon_protocol::mcp::ResourceContent as McpResourceContent;
use crewon_protocol::mcp::ResourceTemplate as McpResourceTemplate;
use crewon_protocol::mcp::Tool as McpTool;
...
v2_enum_from_core!(
    pub enum McpAuthStatus from crewon_protocol::protocol::McpAuthStatus {
        Unsupported,
        NotLoggedIn,
        BearerToken,
        OAuth
...
#[serde(rename_all = "camelCase")]
#[ts(export_to = "v2/")]
pub struct McpServerConfigListParams {
    #[ts(optional = nullable)]
...
#[serde(rename_all = "camelCase")]
#[ts(export_to = "v2/")]
pub struct McpServerConfigListResponse {
    pub data: Vec<McpServerConfigRecord>,
    pub next_cursor: Option<String>,
}
...
#[serde(rename_all = "camelCase")]
#[ts(export_to = "v2/")]
pub struct McpServerConfigReadParams {
    #[ts(optional = nullable)]
    pub cwd: Option<String>,
    pub name: String,
}
...
#[serde(rename_all = "camelCase")]
#[ts(export_to = "v2/")]
pub struct McpServerConfigReadResponse {
    pub record: Option<McpServerConfigRecord>,
}

#[derive(Serialize, Deserialize, Debug, Clone, PartialEq, JsonSchema, TS)]
#[serde(rename_all = "camelCase")]
#[ts(export_to = "v2/")]
pub struct McpServerConfigSaveParams {
    pub name: String,
    pub config: JsonValue,
    #[ts(optional = nullable)]
...
#[serde(rename_all = "camelCase")]
#[ts(export_to = "v2/")]
pub struct McpServerConfigWriteResult {
    pub status: String,
    pub version: String,
...
#[serde(rename_all = "camelCase")]
#[ts(export_to = "v2/")]
pub struct McpServerConfigDeleteParams {
    pub name: String,
    #[ts(optional = nullable)]
    pub expected_version: Option<String>,
    #[serde(default, skip_serializing_if = "std::ops::Not::not")]
...
#[serde(rename_all = "camelCase")]
#[ts(export_to = "v2/")]
pub struct McpServerConfigSaveResponse {
    pub write: McpServerConfigWriteResult,
...
#[serde(rename_all = "camelCase")]
#[ts(export_to = "v2/")]
pub struct McpServerConfigDeleteResponse {
    pub write: McpServerConfigWriteResult,
    pub reload_error: Option<String>,
}
...
impl McpServerElicitationAction {
    pub fn to_core(self) -> crewon_protocol::approvals::ElicitationAction {
        match self {
            Self::Accept => crewon_protocol::approvals::ElicitationAction::Accept,
            Self::Decline => crewon_protocol::approvals::ElicitationAction::Decline,
            Self::Cancel => crewon_protocol::approvals::ElicitationAction::Cancel,
        }
    }
}
...
pub struct McpServerElicitationRequestParams {
    pub thread_id: String,
    /// Active Crewon turn when this elicitation was observed, if app-server could correlate one.
    ///
