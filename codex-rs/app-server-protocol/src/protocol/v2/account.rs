...
use crewon_protocol::protocol::CreditsSnapshot as CoreCreditsSnapshot;
use crewon_protocol::protocol::RateLimitReachedType as CoreRateLimitReachedType;
use crewon_protocol::protocol::RateLimitSnapshot as CoreRateLimitSnapshot;
use crewon_protocol::protocol::RateLimitWindow as CoreRateLimitWindow;
use crewon_protocol::protocol::SpendControlLimitSnapshot as CoreSpendControlLimitSnapshot;
...
pub enum LoginAccountParams {
    ...
    /// The access token must contain the same scopes that Crewon-managed ChatGPT auth tokens have.
    ...
    ChatgptAuthTokens {
        ...
        ///
        /// When `null`, Crewon attempts to derive the plan type from access-token
...
pub enum ChatgptAuthTokensRefreshReason {
    /// Crewon attempted a backend request and received `401 Unauthorized`.
    Unauthorized,
}
...
pub struct ChatgptAuthTokensRefreshParams {
    ...
    /// Workspace/account identifier that Crewon was previously using.
    ///
