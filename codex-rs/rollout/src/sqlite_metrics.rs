...
use crewon_otel::ORIGINATOR_TAG;
use crewon_otel::bounded_originator_tag_value;
use crewon_state::DbTelemetry;
use crewon_state::DbTelemetryHandle;
...
pub(crate) fn recorder(metrics: crewon_otel::MetricsClient, originator: &str) -> DbTelemetryHandle {
