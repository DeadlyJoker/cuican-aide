use crate::default_client::CrewonHttpClient;
use crate::default_client::CrewonRequestBuilder;
...
impl ReqwestTransport {
    pub fn new(client: reqwest::Client) -> Self {
        Self {
            client: CrewonHttpClient::new(client),
        }
    }

    fn build(&self, req: Request) -> Result<CrewonRequestBuilder, TransportError> {
