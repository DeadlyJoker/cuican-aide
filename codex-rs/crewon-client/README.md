...
Generic transport layer that wraps HTTP requests, retries, and streaming primitives without any product-specific or OpenAI-specific awareness.
...
- Consumed by higher-level crates like `crewon-api`; it stays neutral on endpoints, headers, or API-specific error shapes.
