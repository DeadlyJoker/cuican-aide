...
const SESSION_NAME: &str = "Crewon Windows Sandbox WFP";
const PROVIDER_NAME: &str = "Crewon Windows Sandbox WFP";
const PROVIDER_DESCRIPTION: &str = "Persistent WFP provider for Crewon Windows sandbox filters";
const SUBLAYER_NAME: &str = "Crewon Windows Sandbox WFP";
const SUBLAYER_DESCRIPTION: &str = "Persistent WFP sublayer for Crewon Windows sandbox filters";

// WFP identifies persistent providers, sublayers, and filters by stable GUIDs.
// These values are Crewon-owned identities; do not regenerate them unless we
...
/// Installs the persistent Crewon WFP filters for `account`.
///
...
/// Ensures the persistent Crewon WFP provider exists.
...
/// Ensures the persistent Crewon sublayer exists under the Crewon provider.
