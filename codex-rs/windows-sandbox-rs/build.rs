...
const SETUP_BIN: &str = "crewon-windows-sandbox-setup";
const SETUP_MANIFEST: &str = "crewon-windows-sandbox-setup.manifest";
...
fn main() -> Result<(), String> {
    ...
    // Keep this scoped to the setup helper so Crewon binaries that link the
