//! Helpers for truncating tool and exec output using [`TruncationPolicy`](crewon_protocol::protocol::TruncationPolicy).

use crewon_protocol::models::FunctionCallOutputContentItem;
pub use crewon_utils_string::approx_bytes_for_tokens;
pub use crewon_utils_string::approx_token_count;
pub use crewon_utils_string::approx_tokens_from_byte_count;
use crewon_utils_string::truncate_middle_chars;
use crewon_utils_string::truncate_middle_with_token_budget;

pub use crewon_protocol::protocol::TruncationPolicy;
