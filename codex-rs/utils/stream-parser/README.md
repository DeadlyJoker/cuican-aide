# crewon-utils-stream-parser

Small, dependency-free utilities for parsing streamed text incrementally.

**Maintenance note**: This parser is intentionally stateful and handles chunk-boundary edge cases.
Before changing it, read the implementation and update this documentation when behavior changes.
...
```rust
use crewon_utils_stream_parser::CitationStreamParser;
use crewon_utils_stream_parser::StreamTextParser;
...
```rust
use crewon_utils_stream_parser::CitationStreamParser;
use crewon_utils_stream_parser::Utf8StreamParser;

# fn demo() -> Result<(), crewon_utils_stream_parser::Utf8StreamParserError> {
...
```rust
use crewon_utils_stream_parser::InlineHiddenTagParser;
use crewon_utils_stream_parser::InlineTagSpec;
use crewon_utils_stream_parser::StreamTextParser;
