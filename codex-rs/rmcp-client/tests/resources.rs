...
const RESOURCE_URI: &str = "memo://crewon/example-note";

fn stdio_server_bin() -> Result<PathBuf, CargoBinError> {
    crewon_utils_cargo_bin::cargo_bin("test_stdio_server")
}
...
fn init_params() -> InitializeRequestParams {
    ...
    InitializeRequestParams::new(
        capabilities,
        Implementation::new("crewon-test", "0.0.0-test").with_title("Crewon rmcp resource test"),
    )
