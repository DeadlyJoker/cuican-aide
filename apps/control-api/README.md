...
TypeScript Control API composition root. It binds only to `127.0.0.1` and persists Thread, Message, Run, Approval and immutable
AgentVersion authority through the application ports. Standalone derives one Actor/Tenant/Space from trusted local
