...
const ALLOWED_ROOT_LIB_MODULES = [
  // shadcn/ui class-merge helper required by components.json (utils alias).
  "cn.ts",
  "i18n.ts",
  "platform.ts",
  "theme.ts",
...
const LEGACY_ROOT_LIB_MODULES = [
  ...
  "demoData",
  "domainAgentBackend",
  "domainAutomationBackend",
  "domainAutomationContent",
  "domainCollaborationBackend",
  "domainKnowledgeBackend",
  "domainLibraryItems",
  "domainOfficeBackend",
  "domainPersistence",
  "domainToolLibraryItems",
  "domainToolPersistence",
  "domainTypes",
...
function importsBackendImplementation(source: string): boolean {
  return [
    ...
    "lib/domain/domainToolPersistence",
    "lib/domain/domainAgentBackend",
    "lib/domain/domainAutomationBackend",
    "lib/domain/domainCollaborationBackend",
    "lib/domain/domainKnowledgeBackend",
