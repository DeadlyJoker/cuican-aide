...
export function formatRelativeTime(epochSeconds: number, locale: Locale): string {
...
export function formatThreadTimestamp(epochSeconds: number, locale: Locale): string {
