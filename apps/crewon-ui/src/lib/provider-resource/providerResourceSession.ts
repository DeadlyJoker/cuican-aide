...
import type { ResourceType } from "@crewon/app-server-protocol/platform/v2/ResourceType";
import type { WorkspaceRef } from "@crewon/app-server-protocol/platform/v2/WorkspaceRef";
import type { WorkspaceScope } from "@crewon/app-server-protocol/platform/v2/WorkspaceScope";
import type { WorkspaceListResponse } from "@crewon/app-server-protocol/platform/v2/WorkspaceListResponse";
import type { WorkspaceSummary } from "@crewon/app-server-protocol/platform/v2/WorkspaceSummary";
