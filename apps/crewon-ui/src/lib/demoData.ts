...
const demoCopy: Record<Locale, DemoCopy> = {
  ...
  en: {
    ...
    firstUserMessage: "Build a cross-platform Crewon front end for macOS, Windows, and web.",
...
export function getDemoThreads(locale: Locale): Thread[] {
  ...
  return [
    ...
    },
    {
      ...
      forkedFromId: null,
      parentThreadId: null,
      preview: locale === "zh" ? "规划多模型能力接入" : "Plan multi-model provider support",
      ephemeral: true,
      modelProvider: "openai",
      createdAt: now - 7200,
      updatedAt: now - 300,
      ...
      agentRole: null,
      gitInfo: null,
      name: locale === "zh" ? "接入 Claude、Qwen 与 GLM" : "Add Claude, Qwen, and GLM providers",
      turns: [],
    },
    {
      id: "demo-2",
