...
export function settingsSaveFailurePanel(
  ...
  return patchSettingsPanel(
    panel,
    settingsSaveFailurePatch(kind, error, locale),
  );
}
...
export function threadSettingsMissingSelectionPanel(
  ...
  return patchSettingsPanel(panel, threadSettingsMissingSelectionPatch(locale));
}
...
export function threadSettingsSaveSuccessBody(
  ...
  return [
    ...
    patch.model
      ? `${locale === "zh" ? "模型" : "Model"}: ${patch.model}`
      : null,
...
export function threadSettingsSaveFailurePanel(
  ...
  return patchSettingsPanel(
    panel,
    threadSettingsSaveFailurePatch(error, locale),
  );
}
