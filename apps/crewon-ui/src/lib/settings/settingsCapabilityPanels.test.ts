import type { AppInfo } from "@crewon/app-server-protocol/v2/AppInfo";
import type { HookMetadata } from "@crewon/app-server-protocol/v2/HookMetadata";
...
describe("settings panel text helpers", () => {
  ...
  it("builds MCP settings panels", () => {
    ...
    expect(mcpSettingsPanel(emptyInventory, "en")).toEqual({
      ...
      body: "No tools or services have been added yet. Once added, the assistant can use them within your approval settings.",
      rows: [],
      actions: [
