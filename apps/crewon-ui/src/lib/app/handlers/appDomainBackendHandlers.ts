...
type PlatformResourceReaders = Readonly<{
  readAgents: () => Promise<LibraryItem[]>;
  readKnowledge: () => Promise<KnowledgeData>;
  readTools: () => Promise<LibraryItem[]>;
}>;

const defaultPlatformResourceReaders: PlatformResourceReaders = {
  readAgents: readAgentPlatformAgentItems,
  readKnowledge: readAgentPlatformKnowledgeData,
  readTools: readAgentPlatformToolItems,
};
...
export function createAppDomainBackendHandlers(params: {
  ...
  locale: Locale;
  platformResourceReaders?: PlatformResourceReaders;
  ...
  const platformResourceReaders =
    params.platformResourceReaders ?? defaultPlatformResourceReaders;
  ...
  return {
    ...
    loadAgentLibraryItems: async (cwd) =>
      params.platformResourcesEnabled
        ? { items: await platformResourceReaders.readAgents() }
        : loadAppAgentLibraryItems({
            client: params.client,
            cwd,
            locale: params.locale,
    ...
    loadToolLibraryItems: (cwd) =>
      params.platformResourcesEnabled
        ? platformResourceReaders.readTools()
        : loadAppToolLibraryItems({
            client: params.client,
            cwd,
            locale: params.locale,
    ...
    createBackendKnowledgeData: () =>
      params.platformResourcesEnabled
        ? platformResourceReaders.readKnowledge()
        : readBackendKnowledgeData({
            client: params.client,
            locale: params.locale,
            resolveBackendCwd,
