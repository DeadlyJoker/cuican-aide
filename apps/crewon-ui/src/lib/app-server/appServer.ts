import type { AgentMessageDeltaNotification } from "@crewon/app-server-protocol/v2/AgentMessageDeltaNotification";
import type { AccountLoginCompletedNotification } from "@crewon/app-server-protocol/v2/AccountLoginCompletedNotification";
import type { AccountRateLimitsUpdatedNotification } from "@crewon/app-server-protocol/v2/AccountRateLimitsUpdatedNotification";
import type { AccountUpdatedNotification } from "@crewon/app-server-protocol/v2/AccountUpdatedNotification";
import type { AppListUpdatedNotification } from "@crewon/app-server-protocol/v2/AppListUpdatedNotification";
...
import type { CommandExecutionOutputDeltaNotification } from "@crewon/app-server-protocol/v2/CommandExecutionOutputDeltaNotification";
import type { CommandExecOutputDeltaNotification } from "@crewon/app-server-protocol/v2/CommandExecOutputDeltaNotification";
import type { CommandExecResponse } from "@crewon/app-server-protocol/v2/CommandExecResponse";
import type { ConfigReadResponse } from "@crewon/app-server-protocol/v2/ConfigReadResponse";
import type { ConfigRequirementsReadResponse } from "@crewon/app-server-protocol/v2/ConfigRequirementsReadResponse";
import type { ConfigWriteResponse } from "@crewon/app-server-protocol/v2/ConfigWriteResponse";
import type { ConfigWarningNotification } from "@crewon/app-server-protocol/v2/ConfigWarningNotification";
import type { ContextCompactedNotification } from "@crewon/app-server-protocol/v2/ContextCompactedNotification";
import type { ErrorNotification } from "@crewon/app-server-protocol/v2/ErrorNotification";
import type { ExternalAgentConfigDetectResponse } from "@crewon/app-server-protocol/v2/ExternalAgentConfigDetectResponse";
import type { ExternalAgentConfigImportCompletedNotification } from "@crewon/app-server-protocol/v2/ExternalAgentConfigImportCompletedNotification";
...
import type { FileChangePatchUpdatedNotification } from "@crewon/app-server-protocol/v2/FileChangePatchUpdatedNotification";
...
import type { FsReadDirectoryResponse } from "@crewon/app-server-protocol/v2/FsReadDirectoryResponse";
import type { FsReadFileResponse } from "@crewon/app-server-protocol/v2/FsReadFileResponse";
import type { FsCreateDirectoryResponse } from "@crewon/app-server-protocol/v2/FsCreateDirectoryResponse";
import type { FsChangedNotification } from "@crewon/app-server-protocol/v2/FsChangedNotification";
import type { FsWatchResponse } from "@crewon/app-server-protocol/v2/FsWatchResponse";
import type { FsWriteFileResponse } from "@crewon/app-server-protocol/v2/FsWriteFileResponse";
import type { GitDiffToRemoteResponse } from "@crewon/app-server-protocol/GitDiffToRemoteResponse";
import type { GetAuthStatusResponse } from "@crewon/app-server-protocol/GetAuthStatusResponse";
import type { GetConversationSummaryResponse } from "@crewon/app-server-protocol/GetConversationSummaryResponse";
import type { GetAccountResponse } from "@crewon/app-server-protocol/v2/GetAccountResponse";
import type { GetAccountRateLimitsResponse } from "@crewon/app-server-protocol/v2/GetAccountRateLimitsResponse";
import type { GetAccountTokenUsageResponse } from "@crewon/app-server-protocol/v2/GetAccountTokenUsageResponse";
import type { ItemStartedNotification } from "@crewon/app-server-protocol/v2/ItemStartedNotification";
import type { ItemCompletedNotification } from "@crewon/app-server-protocol/v2/ItemCompletedNotification";
import type { LoginAccountResponse } from "@crewon/app-server-protocol/v2/LoginAccountResponse";
import type { LoginAccountParams } from "@crewon/app-server-protocol/v2/LoginAccountParams";
import type { ListMcpServerStatusResponse } from "@crewon/app-server-protocol/v2/ListMcpServerStatusResponse";
import type { LogoutAccountResponse } from "@crewon/app-server-protocol/v2/LogoutAccountResponse";
import type { HooksListResponse } from "@crewon/app-server-protocol/v2/HooksListResponse";
import type { McpServerOauthLoginCompletedNotification } from "@crewon/app-server-protocol/v2/McpServerOauthLoginCompletedNotification";
import type { McpServerConfigDeleteResponse } from "@crewon/app-server-protocol/v2/McpServerConfigDeleteResponse";
import type { McpServerConfigListResponse } from "@crewon/app-server-protocol/v2/McpServerConfigListResponse";
import type { McpServerConfigReadResponse } from "@crewon/app-server-protocol/v2/McpServerConfigReadResponse";
import type { McpServerConfigSaveResponse } from "@crewon/app-server-protocol/v2/McpServerConfigSaveResponse";
import type { McpServerRefreshResponse } from "@crewon/app-server-protocol/v2/McpServerRefreshResponse";
import type { McpResourceReadResponse } from "@crewon/app-server-protocol/v2/McpResourceReadResponse";
import type { McpServerToolCallResponse } from "@crewon/app-server-protocol/v2/McpServerToolCallResponse";
import type { McpServerStatusUpdatedNotification } from "@crewon/app-server-protocol/v2/McpServerStatusUpdatedNotification";
import type { McpServerOauthLoginResponse } from "@crewon/app-server-protocol/v2/McpServerOauthLoginResponse";
import type { McpToolCallProgressNotification } from "@crewon/app-server-protocol/v2/McpToolCallProgressNotification";
import type { AgentCreateResponse } from "@crewon/app-server-protocol/v2/AgentCreateResponse";
import type { AgentUpdateResponse } from "@crewon/app-server-protocol/v2/AgentUpdateResponse";
import type { ModelListResponse } from "@crewon/app-server-protocol/v2/ModelListResponse";
import type { ModelProviderCapabilitiesReadResponse } from "@crewon/app-server-protocol/v2/ModelProviderCapabilitiesReadResponse";
import type { ModelProviderProbeResponse } from "@crewon/app-server-protocol/v2/ModelProviderProbeResponse";
import type { PermissionProfileListResponse } from "@crewon/app-server-protocol/v2/PermissionProfileListResponse";
...
import type { PluginSkillReadResponse } from "@crewon/app-server-protocol/v2/PluginSkillReadResponse";
import type { PlanDeltaNotification } from "@crewon/app-server-protocol/v2/PlanDeltaNotification";
import type { OfficeRunUpdatedNotification } from "@crewon/app-server-protocol/v2/OfficeRunUpdatedNotification";
import type { WorkflowRunUpdatedNotification } from "@crewon/app-server-protocol/v2/WorkflowRunUpdatedNotification";
import type { RemoteControlStatusChangedNotification } from "@crewon/app-server-protocol/v2/RemoteControlStatusChangedNotification";
import type { ReasoningSummaryPartAddedNotification } from "@crewon/app-server-protocol/v2/ReasoningSummaryPartAddedNotification";
import type { ReasoningSummaryTextDeltaNotification } from "@crewon/app-server-protocol/v2/ReasoningSummaryTextDeltaNotification";
import type { ReasoningTextDeltaNotification } from "@crewon/app-server-protocol/v2/ReasoningTextDeltaNotification";
...
import type { SandboxPolicy } from "@crewon/app-server-protocol/v2/SandboxPolicy";
import type { SandboxMode } from "@crewon/app-server-protocol/v2/SandboxMode";
import type { ServerRequestResolvedNotification } from "@crewon/app-server-protocol/v2/ServerRequestResolvedNotification";
import type { SkillsChangedNotification } from "@crewon/app-server-protocol/v2/SkillsChangedNotification";
import type { SkillsCreateResponse } from "@crewon/app-server-protocol/v2/SkillsCreateResponse";
import type { SkillsListResponse } from "@crewon/app-server-protocol/v2/SkillsListResponse";
import type { SkillsConfigWriteResponse } from "@crewon/app-server-protocol/v2/SkillsConfigWriteResponse";
import type { SkillsExtraRootsSetResponse } from "@crewon/app-server-protocol/v2/SkillsExtraRootsSetResponse";
...
import type { ThreadArchivedNotification } from "@crewon/app-server-protocol/v2/ThreadArchivedNotification";
import type { ThreadDeletedNotification } from "@crewon/app-server-protocol/v2/ThreadDeletedNotification";
import type { ThreadForkResponse } from "@crewon/app-server-protocol/v2/ThreadForkResponse";
import type { ThreadGoalClearedNotification } from "@crewon/app-server-protocol/v2/ThreadGoalClearedNotification";
import type { ThreadGoalGetResponse } from "@crewon/app-server-protocol/v2/ThreadGoalGetResponse";
import type { ThreadGoalSetResponse } from "@crewon/app-server-protocol/v2/ThreadGoalSetResponse";
import type { ThreadGoalStatus } from "@crewon/app-server-protocol/v2/ThreadGoalStatus";
import type { ThreadGoalUpdatedNotification } from "@crewon/app-server-protocol/v2/ThreadGoalUpdatedNotification";
import type { ThreadListResponse } from "@crewon/app-server-protocol/v2/ThreadListResponse";
import type { ThreadNameUpdatedNotification } from "@crewon/app-server-protocol/v2/ThreadNameUpdatedNotification";
import type { ThreadResumeResponse } from "@crewon/app-server-protocol/v2/ThreadResumeResponse";
import type { ThreadSettingsUpdatedNotification } from "@crewon/app-server-protocol/v2/ThreadSettingsUpdatedNotification";
import type { ThreadStartResponse } from "@crewon/app-server-protocol/v2/ThreadStartResponse";
import type { ThreadExecutionContext } from "@crewon/app-server-protocol/platform/v2/ThreadExecutionContext";
import type { ThreadExecutionContextCreateParams } from "@crewon/app-server-protocol/platform/v2/ThreadExecutionContextCreateParams";
import type { ThreadStartedNotification } from "@crewon/app-server-protocol/v2/ThreadStartedNotification";
import type { ThreadStatusChangedNotification } from "@crewon/app-server-protocol/v2/ThreadStatusChangedNotification";
import type { ThreadTokenUsageUpdatedNotification } from "@crewon/app-server-protocol/v2/ThreadTokenUsageUpdatedNotification";
import type { ThreadUnarchiveResponse } from "@crewon/app-server-protocol/v2/ThreadUnarchiveResponse";
import type { ThreadUnarchivedNotification } from "@crewon/app-server-protocol/v2/ThreadUnarchivedNotification";
import type { Turn } from "@crewon/app-server-protocol/v2/Turn";
import type { TurnCompletedNotification } from "@crewon/app-server-protocol/v2/TurnCompletedNotification";
import type { TurnDiffUpdatedNotification } from "@crewon/app-server-protocol/v2/TurnDiffUpdatedNotification";
import type { TurnPlanUpdatedNotification } from "@crewon/app-server-protocol/v2/TurnPlanUpdatedNotification";
import type { TurnStartedNotification } from "@crewon/app-server-protocol/v2/TurnStartedNotification";
...
import type { WarningNotification } from "@crewon/app-server-protocol/v2/WarningNotification";
import type { WindowsSandboxReadinessResponse } from "@crewon/app-server-protocol/v2/WindowsSandboxReadinessResponse";
import type {
  ExpertRole,
  ExpertTeamRecordReference,
} from "../experts/expertTeamRecord";
import type { WindowsSandboxSetupMode } from "@crewon/app-server-protocol/v2/WindowsSandboxSetupMode";

type PlatformThreadStartResponse = ThreadStartResponse & {
  executionContext: ThreadExecutionContext | null;
};
import type { WindowsSandboxSetupStartResponse } from "@crewon/app-server-protocol/v2/WindowsSandboxSetupStartResponse";
import type {
  AgentConfig,
  ArtifactItem,
  AutomationConfig,
