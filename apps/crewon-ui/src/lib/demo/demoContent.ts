...
export function demoCapabilityPanel(
  ...
  if (tool === "terminal") {
    return {
      ...
      commandInput: true,
      body: "$ pnpm --filter @crewon/control-api test\n\nTest Files  42 passed (42)\nTests       318 passed (318)\nDuration    8.4s",
    };
  }
  if (tool === "files") {
    return {
      ...
      items: [
        ...
        {
          label: "> services",
          path: "/Users/me/work/crewon/services",
          kind: "directory",
        },
        {
          label: "  AGENTS.md",
  ...
  const trace = zh(locale)
    ...
    : [
        ...
        },
        {
          ...
          accent: "violet" as const,
          action: "Run command",
          detail: "Control API tests · 318 passed",
          tokens: 880,
          status: "done" as const,
        },
        {
  ...
  const memories = zh(locale)
    ? [
        ...
        },
        {
          ...
          accent: "blue" as const,
          kind: "规则",
          preview: "新功能先写清验收标准；界面交互和文案保持一致。",
          meta: "来自 AGENTS.md",
        },
        {
          title: "测试方式",
    ...
    : [
        ...
        },
        {
          ...
          accent: "blue" as const,
          kind: "Rule",
          preview: "Define acceptance criteria first and keep interactions consistent.",
          meta: "From AGENTS.md",
        },
        {
          title: "Testing",
          ...
          accent: "green" as const,
          kind: "Process",
          preview: "Verify affected features first, then run the full release regression.",
          meta: "Engineer note",
        },
        {
