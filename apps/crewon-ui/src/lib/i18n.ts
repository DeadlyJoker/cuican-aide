...
const messages: Record<Locale, Messages> = {
  zh: {
    ...
    connecting: "连接中",
    connectionHints: {
      connected: "已连接 CrewON Control",
      connecting: "正在连接 CrewON Control",
      disconnected: "CrewON Control 已断开，请求暂不发送",
      demo: "演示模式",
    },
    ...
    draftUnsaved: "草稿未发送",
    emptyDescription:
      "连接 CrewON Control 后即可浏览项目会话、继续对话，并在 macOS、Windows 和 web 使用同一套体验。",
  ...
  en: {
    ...
    connectionHints: {
      connected: "Connected to CrewON Control",
      connecting: "Connecting to CrewON Control",
      disconnected: "CrewON Control disconnected; requests are paused",
      demo: "Demo mode",
    },
    connectionLost:
    ...
    emptyDescription:
      "Connect to CrewON Control to browse project sessions, continue chats, and use the same workspace across macOS, Windows, and web.",
