...
describe("TitleBarWindowControls", () => {
  ...
  it("renders real macOS controls for the command workspace", () => {
    ...
    expect(markup).toMatchInlineSnapshot(
      `"<div aria-label=\"窗口控制\" class=\"window-controls traffic\" data-window-controls=\"native\" role=\"group\"><button aria-label=\"关闭窗口\" class=\"traffic-light close\" data-window-action=\"close\" title=\"关闭窗口\" type=\"button\"></button><button aria-label=\"最小化窗口\" class=\"traffic-light minimize\" data-window-action=\"minimize\" title=\"最小化窗口\" type=\"button\"></button><button aria-label=\"缩放窗口\" class=\"traffic-light zoom\" data-window-action=\"zoom\" title=\"缩放窗口\" type=\"button\"></button></div>"`,
    );
  });
