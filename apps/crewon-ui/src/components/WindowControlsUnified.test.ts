...
describe("window controls", () => {
  ...
  /*
   * Drawing the chrome and calling the host are different questions. The chrome
  ...
  it("draws the chrome by surface but calls the host by bridge", () => {
    ...
    expect(controls).not.toContain("@tauri-apps");
  });
  ...
  it("gives the frameless window a drag surface", () => {
    ...
    expect(frame).toContain("data-desktop-drag-region");
  });
